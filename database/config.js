...
db.serialize(() => {
  ...
  //db.run(`CREATE TABLE answers (id INTEGER PRIMARY KEY AUTOINCREMENT, question_id INTEGER, selected_option INTEGER, is_correct BOOLEAN)`);
  // Modify this line in db.serialize()
